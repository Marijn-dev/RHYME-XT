...
def main():
    ...
    if analyze_results == True:
        ...
        data = [error_T50/100, error_T100/100, error_T250/100]
        labels = ["50", "100", "250"]
        ...
        plt.ylim(0, 0.6)  # change 0 and 10 to your desired min and max
        plt.grid(True)
        plt.savefig('amari_timehorizons_boxplot_cut.pdf',dpi=300)
